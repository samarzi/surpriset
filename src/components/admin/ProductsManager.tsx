    ...
    <div className="w-full">
      <div className="space-y-3 w-full md:pt-24">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div>
            <h1 className="text-xl md:text-2xl font-bold text-foreground dark:text-white">Управление товарами</h1>
                ...
                <div className="flex items-center gap-2 w-full">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1.5 mb-0.5 flex-wrap">
                      <h3 className="font-semibold text-xs text-foreground dark:text-white truncate">{product.name}</h3>
                    ...
                    <div className="flex items-center gap-2 text-[10px] text-gray-600 dark:text-gray-400">
                      ...
                      <span className="font-bold text-foreground dark:text-white">{product.price}₽</span>
                  ...
                  <div className="flex items-center gap-1 flex-shrink-0 ml-auto pl-2">
                    <Button
                      ...
                      className="h-8 w-8 p-0 hover:bg-blue-50 dark:hover:bg-blue-900/30 text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 dark:text-gray-400"
                      title="Изменить"
                    >
                    ...
                    <Button
                      ...
                      className="h-8 w-8 p-0 hover:bg-green-50 dark:hover:bg-green-900/30 text-gray-500 hover:text-green-600 dark:hover:text-green-400 dark:text-gray-400"
                      title="Дублировать"
                    >
                    ...
                    <Button
                      ...
                      className="h-8 w-8 p-0 hover:bg-orange-50 dark:hover:bg-orange-900/30 text-gray-500 hover:text-orange-600 dark:hover:text-orange-400 dark:text-gray-400"
                    ...
                    <Button
                      ...
                      className="h-8 w-8 p-0 hover:bg-red-50 dark:hover:bg-red-900/30 text-gray-500 hover:text-red-600 dark:hover:text-red-400 dark:text-gray-400"
                      title="Удалить"
                    >
