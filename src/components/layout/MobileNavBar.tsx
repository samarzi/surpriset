...
export function MobileNavBar() {
  ...
  // Скрываем навигацию на странице админ панели, при оформлении заказа и в карточке товара
  if (location.pathname.startsWith('/admin') || location.pathname.startsWith('/checkout') || location.pathname.startsWith('/product')) {
    return null
  }
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    active
                      ? 'bg-brand-gradient text-black font-extrabold shadow-lg scale-105 transform'
                      : 'text-foreground dark:text-gray-200 hover:text-primary dark:hover:text-primary transform font-semibold'
                  )}
                >
                  <div className="relative">
                    ...
                    {isCart && cartItemCount > 0 && (
                      <span className="absolute -top-1 -right-1 bg-red-500 text-white text-[9px] rounded-full h-4.5 w-4.5 flex items-center justify-center font-extrabold border-2 border-background shadow-lg">
