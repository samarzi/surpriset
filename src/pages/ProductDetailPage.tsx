...
export default function ProductDetailPage() {
  ...
  return (
    <>
      <div
        className="min-h-screen bg-background pb-20 sm:pb-4 swipe-back-container"
        {...handlers}
      >
        ...
        >
          ...
          <div className="container px-2 sm:px-3 lg:px-4 pb-6 sm:pb-8">
            <div className="mt-4 sm:mt-6 lg:mt-8 border-t pt-3 sm:pt-4 lg:pt-6">
              <RecommendedProducts
                currentProductId={product.id}
                categoryIds={(product as { category_ids?: string[] }).category_ids || []}
                limit={6}
              />
            </div>
          </div>
